...
\lstinline!max!, etc.).
Non-\pencil functions annotated with the \lstinline!const! attribute,
do not need any summary for their side effects as
the \lstinline!const! attribute indicates that the function does
