...
Specific Language (DSL) \nomenclature{DSL}{Domain Specific Language} and to
lower that code through an optimizing
compiler.
...
\nomenclature{C99}{C Standard 1999}
...
C extensions~\cite{gccguide} such as type attributes, and exploits pragmas when no alternative
was available.
