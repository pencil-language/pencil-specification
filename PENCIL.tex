...
In addition, if this language is a high level language that can also
be used directly by domain experts to target accelerators, the
...
% - calls to other summaries are allowed.
  ...
  Summary functions were chosen over other formalisms (C++11 lambda
